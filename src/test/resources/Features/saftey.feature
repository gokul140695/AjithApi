...
Feature: Address Module API Automation
  ...
  Scenario Outline: Verify add user address to the application through api
    ...
    Examples: 
      ...
      | Gokul      | name      | 8907654327 | Gokul Apartment |    25 |   30 |      30 |  610004 | Chennai | Home         |
  ...
  Scenario Outline: Verify update user address to the application through api
    ...
    When User add request body for update user address addressId and "<first_name>" , "<last_name>" , "<mobile>" , "<apartment>" , "<state>" , "<city>" , "<country>" , "<zipcode>" , "<address>" and "<address_type>"
